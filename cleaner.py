"""
    ...
    Usage:
        ...
        (certs) certs@learning-tribes:~$ /edx/app/certs/venvs/certs/bin/python /edx/app/certs/certificates/cleaner.py --target_type=[s3|dfs] --start_date=[date of dfs] [--dryrun]
